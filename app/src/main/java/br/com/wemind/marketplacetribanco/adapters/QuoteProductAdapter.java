...
public class QuoteProductAdapter extends RecyclerView.Adapter<QuoteProductAdapter.ViewHolder> implements Filterable {
    ...
    @Override
    public QuoteProductAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new QuoteProductAdapter.ViewHolder((ItemSimpleProductBinding) DataBindingUtil.inflate(
