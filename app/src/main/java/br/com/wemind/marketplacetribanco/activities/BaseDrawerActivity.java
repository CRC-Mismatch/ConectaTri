...
public abstract class BaseDrawerActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        search.setLayoutParams(new Toolbar.LayoutParams(Gravity.END));
    }

    protected void bindViews() {
        b = DataBindingUtil.setContentView(this, R.layout.activity_base_drawer);
        contentFrame = b.contentFrame;
        toolbar = b.toolbar;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        */
        ...
        contentFrame.animate().alpha(0).setDuration(MAIN_CONTENT_FADEOUT_DURATION);
